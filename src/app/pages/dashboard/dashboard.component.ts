...
export class DashboardComponent {
  ...
  movie = [
    {
      ...
      Poster: "https://www.youtube.com/watch?v=rHm1fPx1ZIo",
      Metascore: "65",
      imdbRating: "7.2",
      imdbVotes: "653,874",
      imdbID: "tt0480249",
  ...
  getPeopleList(){
    this.generalService.getPeopleList().subscribe((res) => {
        if(res){
            this.people = Object.values(res)[0];
        }
  ...
  getActivityList(){
    this.generalService.getActivityList().subscribe((res) => {

        if(res){
            this.activity = Object.values(res)[0];
        }
  ...
  getProductsList(){
    this.generalService.getProductsList().subscribe((res) => {
        if(res){
            this.channel = Object.values(res)[0];
        }
        
    })
  }
  getDocumentList(){
    this.generalService.getDocumentList().subscribe((res) => {
        if(res){
            this.document = Object.values(res)[0];
        }
